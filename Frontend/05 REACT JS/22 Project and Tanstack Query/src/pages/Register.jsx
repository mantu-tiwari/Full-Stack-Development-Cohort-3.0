...
const Register = () => {
  let { navigate, handleSubmit, registerSubmit, errors, register } = useAuth();
  return (
    <div className="grid min-h-screen place-items-center bg-gray-50 p-4">
      <div className="w-full max-w-sm space-y-6 rounded-2xl bg-white p-8 shadow-md">
        ...
        <form onSubmit={handleSubmit(registerSubmit)} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-orange-600 py-2 text-sm font-semibold text-white transition hover:bg-orange-700"
          >
            Register
          </button>
        </form>
